      ...
      <div className="w-full max-w-md">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-primary-50 p-5 sm:p-8">
          <svg
            ...
            aria-hidden="true"
          >
            <path d="M10 90C10 60 30 30 60 15" stroke="currentColor" strokeWidth="3" strokeLinecap="round" />
          ...
          <svg
            ...
            aria-hidden="true"
          >
            <path d="M90 10C90 40 70 70 40 85" stroke="currentColor" strokeWidth="3" strokeLinecap="round" />
          ...
          <div className="relative rounded-xl border border-neutral-200 bg-white p-6 shadow-card sm:p-7">
            {error && (
              <p role="alert" className="mb-4 rounded-lg bg-danger-50 p-3 text-center text-sm text-danger-600">
                {error}
              </p>
            )}
            <LoginForm />
