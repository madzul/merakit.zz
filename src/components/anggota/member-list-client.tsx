...
import { deleteMemberAction } from "@/lib/anggota/actions";
...
interface MemberListClientProps {
  ...
  /** True bila pengambilan data awal di server gagal (mis. galat koneksi Supabase). */
  initialLoadError: boolean;
}

/**
 * Bagian interaktif (filter, pencarian, pagination, hapus) dari daftar
 * anggota. Hanya dirender untuk admin — src/app/(dashboard)/dashboard/anggota/page.tsx
 * mengarahkan anggota biasa ke halaman detail profilnya sendiri sebelum
 * sampai ke komponen ini.
 */
export function MemberListClient({ initialMembers, initialLoadError }: MemberListClientProps) {
